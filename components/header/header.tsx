...
const Header: React.FC<SwiperProps> = ({ hideBack,onBack }) => {
  ...
  const onMouseEnter = (event: React.MouseEvent<HTMLHeadingElement, MouseEvent>) => {
    startAnimation();
  };

  const onMouseLeave = throttle((event: React.MouseEvent<HTMLHeadingElement, MouseEvent>) => {
    restoreAnimation()
  }, 1000, {
    'leading': true,
    'trailing': false
  ...
  return (
    ...
    <div className={styles.headingCtr} ref={container}>
      ...
      <div className={styles.screenTitle} >
        ...
        aria-label="Juicebox Logo Image"
          tabIndex={0}
          ...
          <svg
            ...
            <path className="juiceEaseOut" d="M45.2569 12.9626C46.7213 12.9626 47.7627 13.9354 48.0881 15.3621L53.2407 14.3569C52.4597 10.6279 49.2054 8.26074 45.2244 8.26074C40.6901 8.26074 37.0779 11.5682 37.0779 16.1836C37.0779 20.7989 40.6901 24.1389 45.2244 24.1389C49.1946 24.1389 52.4922 21.7717 53.2407 18.0319L48.0881 17.0267C47.7627 18.4534 46.7213 19.4262 45.2569 19.4262C43.5322 19.4262 42.2955 18.0319 42.2955 16.1836C42.2955 14.3029 43.5322 12.9626 45.2569 12.9626Z" fill="#FAFAFA" />
            <path className="juiceEaseOut" d="M62.4609 8.26074C57.8616 8.26074 54.4446 11.6007 54.4446 16.1836C54.4446 20.7989 57.9266 24.1389 62.526 24.1389C66.0406 24.1389 68.9477 22.6797 70.3145 19.1992L65.1619 18.3562C64.7389 19.2317 63.6975 19.7181 62.6562 19.7181C61.1592 19.7181 60.1504 18.7128 59.9226 17.6428H70.6074V17.3509C70.6074 10.9197 66.7348 8.26074 62.4609 8.26074ZM59.7599 14.4001C60.0202 13.2652 61.0616 12.4221 62.4609 12.4221C63.8602 12.4221 64.9016 13.2652 65.1619 14.4001H59.7599Z" fill="#FAFAFA" />
            <path className="juiceEaseOut" d="M98.9956 8.26074C94.4613 8.26074 90.8491 11.5682 90.8491 16.1836C90.8491 20.7989 94.4613 24.1389 98.9956 24.1389C103.53 24.1389 107.142 20.7989 107.142 16.1836C107.142 11.5682 103.519 8.26074 98.9956 8.26074ZM98.9956 19.4262C97.2709 19.4262 96.0668 18.0319 96.0668 16.1836C96.0668 14.3029 97.2709 12.9734 98.9956 12.9734C100.688 12.9734 101.924 14.3029 101.924 16.1836C101.924 18.0319 100.688 19.4262 98.9956 19.4262Z" fill="#FAFAFA" />
            <path className="juiceEaseOut" d="M123.5 8.64966H117.664L115.614 12.4435L113.65 8.64966H107.63L111.991 16.1834L107.565 23.7495H113.553L115.516 19.8476L117.534 23.7495H123.5L119.161 16.0861L123.5 8.64966Z" fill="#FAFAFA" />
